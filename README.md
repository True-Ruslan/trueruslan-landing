...
Исходный код, build/test tooling и CI-конфигурация лицензируются по **Apache License 2.0** — см. [`LICENSE`](LICENSE).

CV, персональные фотографии, биографический/профильный текст и другие персональные материалы не передаются по Apache-2.0 и остаются защищёнными авторским правом, если явно не указано обратное. Подробности — [`CONTENT-LICENSE.md`](CONTENT-LICENSE.md).
