...
{% include notitle [Generated English publications catalogue](../_includes/publications-catalogue.en.md) %}

{% note info %}

Only material with a verifiable external publication point is included: an article or journal page, DOI, official event programme, recording, proceedings page or another durable source. Drafts, submitted work, future talks and material still in progress are not listed here.
