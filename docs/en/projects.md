...
<h3>VillAIgence</h3>
<p>An AI society layer for Minecraft where the server owns state, memory and actions; the model can suggest actions but does not own world state.</p>
...
<a class="tr-project-index-card__cta" href="en/projects/livingworld.html">Open project →</a>
</article>
...
<a class="tr-project-index-card__cta" href="en/projects/notchhub.html">Open project →</a>
</article>
...
<p>A static engineering portfolio and knowledge platform with canonical registries, RU/EN pages, clean URLs and automated build, browser and production checks.</p>
...
<a class="tr-project-index-card__cta" href="en/projects/portfolio-platform.html">Open project →</a>
</article>
</div>
...
<h3>MarketDB</h3>
<p><strong>Status:</strong> closed. A historical independent commercial project: a production marketplace-analytics platform. My work covered backend engineering, data, integrations and the evolution of a live system without exposing proprietary architecture.</p>
...
<a class="tr-project-index-card__cta" href="en/projects/vlezet.html">Open project →</a>
</article>
...
<a class="tr-project-index-card__cta" href="landing/projects/node-zero.html">Open project — Russian (RU) →</a>
</article>

<article class="tr-project-index-card tr-project-index-card--compact" data-c3-lab="taskhub">
<h3>TaskHub</h3>
<p>A backend + AI project about service boundaries, data, integrations and reproducible infrastructure.</p>
<a class="tr-project-index-card__cta" href="landing/projects/taskhub.html">Open project — Russian (RU) →</a>
</article>
...
<a class="tr-project-index-card__cta" href="landing/projects/minichess.html">Open project — Russian (RU) →</a>
</article>
...
<p>A reusable foundation for small atmospheric games and documentation-driven, AI-assisted development experiments.</p>
<a class="tr-project-index-card__cta" href="landing/projects/godot-horror-template.html">Open project — Russian (RU) →</a>
</article>
</div>
