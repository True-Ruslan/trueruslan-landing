...
test('VillAIgence page separates 0.3.1 installed FAIL from published 0.3.2 and pending installed acceptance', () => {
  ...
  assert.match(page, /0\.3\.1[\s\S]{0,500}FAIL/i);
  assert.match(page, /0\.3\.2\+1\.21\.1/);
  assert.match(page, /PR #169/);
  assert.match(page, /PR #171/);
  assert.match(page, /b51cfcf3f46718fac9620586cf8b5aae53356c600d5ac375ca3280050befe015/);
