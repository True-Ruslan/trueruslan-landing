...
const PROJECTS = [
  {
    ...
    borderStyle: 'solid',
    signals: 7,
    stateCounts: {merged: 3, failed: 1, unavailable: 2, pending: 1},
    requiredText: [
      'M7.8B',
  ...
  },
  {
    ...
    borderStyle: 'solid',
    signals: 14,
    stateCounts: {accepted: 2, failed: 1, merged: 8, published: 2, pending: 1},
    requiredText: [
      'PR #103',
      'PR #104',
      'PR #105',
      ...
      'VAI-M2-INST-005',
      'VAI-CONCUR-004',
      'BELIEF admission PR #123',
      'BELIEF candidate extraction Draft PR #125',
      'SYSTEM_OBSERVED',
