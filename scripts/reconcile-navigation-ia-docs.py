...
state_marker = "## 0.3 2026-08-12 — Real GSC baseline + controlled launch pack"
state_section = f"""## 0.4 2026-08-12 — Navigation information architecture — PRODUCTION ACCEPTED
...
"""
text = replace_once(text, state_marker, state_section + state_marker, "PROJECT_STATE section")
...
roadmap_marker = "## 2026-08-12 accepted real search baseline / controlled launch pack"
roadmap_section = """## 2026-08-12 accepted Navigation information architecture
...
"""
text = replace_once(text, roadmap_marker, roadmap_section + roadmap_marker, "ROADMAP section")
...
changelog_marker = "## 2026-08-12 — Real GSC baseline + controlled launch pack"
changelog_section = """## 2026-08-12 — Navigation information architecture — PRODUCTION ACCEPTED
...
"""
text = replace_once(text, changelog_marker, changelog_section + changelog_marker, "CHANGELOG section")
