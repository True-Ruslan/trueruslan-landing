...
test('deployment verification note is exposed through registry index toc and page metadata', () => {
  ...
  assert.ok(
    ...
    'missing deployment verification Note from canonical Notes Registry',
  );
