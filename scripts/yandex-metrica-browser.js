...
var copy=locale==='en'?{prompt:'Analytics cookies?',allow:'Allow',deny:'Refuse',settings:'Cookies'}:{prompt:'Cookies для статистики?',allow:'Разрешить',deny:'Не разрешать',settings:'Cookies'};
